...
hoods = ['ALAMEDA', 'ARBOR LODGE', 'ARDENWALD-JOHNSON CREEK', 'ARGAY TERRACE',
 ...
 'NORTH TABOR', 'NORTHWEST DISTRICT', 'NORTHWEST HEIGHTS', 'OLD TOWN',
 'OVERLOOK', 'PARKROSE', 'PARKROSE HEIGHTS', 'PEARL DISTRICT', 'PIEDMONT', 'PLEASANT VALLEY',
